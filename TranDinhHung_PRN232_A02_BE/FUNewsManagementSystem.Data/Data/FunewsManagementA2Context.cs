...
namespace FUNewsManagementSystem.Data.Data;

public partial class FunewsManagementA2Context : DbContext
{
    public FunewsManagementA2Context()
    {
    }

    public FunewsManagementA2Context(DbContextOptions<FunewsManagementA2Context> options)
        : base(options)
    {
    }
